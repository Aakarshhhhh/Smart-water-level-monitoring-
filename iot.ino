...
#define BLYNK_TEMPLATE_ID "TMPL3otcfLkEk"
#define BLYNK_TEMPLATE_NAME "water monitoring system"
#define BLYNK_AUTH_TOKEN "HPpxDyGp61tFh_G_GFNnQs1ApoZ9JtXn"
#include <BlynkSimpleEsp8266.h>

//Initialize the LCD display
LiquidCrystal_I2C lcd(0x27, 16, 2);

char auth[] = "HPpxDyGp61tFh_G_GFNnQs1ApoZ9JtXn";//Enter your Auth token
